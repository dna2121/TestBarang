...
public class TambahData extends AppCompatActivity {
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(etKode.getText().toString().isEmpty()) && !(etNama.getText().toString().isEmpty()))
                    ...
                    Toast.makeText(getApplicationContext(), "Data cannot be empty.",
    ...
    public void submitBrg (Barang brg){
        ...
        FIrebase Realtime Database dan juga
        kita set onSuccessListener yang berisi kode yang akan dijalankan
        ...
        database.child("Barang").push().setValue(brg).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                etKode.setText("");
                etNama.setText("");
                Toast.makeText(getApplicationContext(), "Data added successfully",
                        Toast.LENGTH_LONG).show();
            }
        });
    }
